...
def zoom_dowm(ptz,request,timeout=1):
    ...
    request.Velocity.PanTilt.y = 0
    perform_move(ptz, request, timeout)
# if media_profile.PTZConfiguration is None:
#     print("❌ This profile has no PTZ configuration. PTZ won't work.")
#     return


def continuous_move():
    mycam = ONVIFCamera('192.168.11.206', 80, 'admin', 'admin@1234')
